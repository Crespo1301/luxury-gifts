      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {t.categories.items.map((c, i) => (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-100 to-blush-200 text-rose-500 ring-1 ring-white/80">
              ...
              <div className="mt-4 flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-gold-600">
